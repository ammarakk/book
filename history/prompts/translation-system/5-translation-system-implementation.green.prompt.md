...
labels: [implementation, translation, english-urdu, claude-subagents]
links:
  spec: ../specs/005-translation-system/spec.md
  plan: ../specs/005-translation-system/plan.md
  tasks: ../specs/005-translation-system/tasks.md
  ticket: null
  adr: null
  pr: null
files:
  - ../docusaurus/src/components/TranslationToggle.js
  - ../docusaurus/src/components/TranslatedContent.js
  - ../docusaurus/src/services/translation.js
  - ../docusaurus/src/css/translation.css
  - ../backend/src/api/translation.py
  - ../backend/src/services/translation.py
  - ../backend/src/models/translation.py
  - ../backend/src/config/translation.py
  - ../agents/claude-subagents/translation-agent.py
  - ../agents/claude-subagents/agent-skills/term-preservation.py
  - ../agents/claude-subagents/agent-skills/code-protection.py
  - ../agents/claude-subagents/agent-skills/formatting-maintenance.py
  - ../backend/main.py
  - ../backend/requirements.txt
  - ../docusaurus/package.json
  - ../specs/005-translation-system/api-documentation.md
  - ../specs/005-translation-system/verification-checklist.md
